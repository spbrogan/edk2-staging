...
[LibraryClasses]
  ...
  UefiVariablePolicyLib|MdeModulePkg/Library/UefiVariablePolicyLib/UefiVariablePolicyLib.inf  # MU_CHANGE
  #
  # Generic Modules
  #
...
## MU_CHANGE BEGIN
  # Add missing components to the build.
  ...
  # Add test components to the build.
